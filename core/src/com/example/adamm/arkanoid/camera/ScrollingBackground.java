...
public class ScrollingBackground {
    ...
    public ScrollingBackground () {
        ...
        imageScale = Arkanoid.WIDTH / image.getWidth();
        speedFixed = true;
    }
    ...
    public void updateAndRender (float deltaTime, SpriteBatch batch) {
        ...
        //Render
        batch.draw(image, 0, y1, Arkanoid.WIDTH, image.getHeight() * imageScale);
        batch.draw(image, 0, y2, Arkanoid.WIDTH, image.getHeight() * imageScale);
    }
